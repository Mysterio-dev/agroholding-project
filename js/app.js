        ...
        document.addEventListener("DOMContentLoaded", (() => {
            function ekUpload() {
                function Init() {
                    ...
                    let fileSelect = document.getElementById("file-upload"), fileDrag = document.getElementById("file-drag");
                ...
                function fileDragHover(e) {
                    ...
                    e.stopPropagation();
                    e.preventDefault();
                    fileDrag.className = "dragover" === e.type ? "hover" : "modal-body file-upload";
                }
                ...
                function uploadFile(file) {
                    let xhr = new XMLHttpRequest, fileSizeLimit = (document.getElementById("class-roster-file"), 
                    1024);
                    if (xhr.upload) if (file.size <= 1024 * fileSizeLimit * 1024) {
                        ...
                        xhr.send(file);
                    } else output("Please upload a smaller file (< " + fileSizeLimit + " MB).");
                }
                if (window.File && window.FileList && window.FileReader) Init(); else document.getElementById("file-drag").style.display = "none";
            }
            ekUpload();
        }));
